...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("payments", "0024_astrum_pay_in_session"),
    ]

    operations = [
        migrations.CreateModel(
            name="PayplatPayOutSession",
            fields=[
                ("id", models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ("external_id", models.CharField(db_index=True, max_length=128)),
                ("provider_payout_id", models.CharField(blank=True, db_index=True, default="", max_length=128)),
