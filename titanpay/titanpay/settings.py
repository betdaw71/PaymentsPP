...
ARBITRAGE_LIMIT = 3
# Блокировать PaymentDetailsGroup (status=4) при арбитраже — по умолчанию выключено.
ARBITRAGE_BLOCK_REQUISITE = os.getenv('ARBITRAGE_BLOCK_REQUISITE', 'false').lower() in ('true', '1', 'yes')
RATE_UPD_TIME = 60
