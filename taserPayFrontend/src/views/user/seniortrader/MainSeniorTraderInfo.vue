...
const isTelegramEditable = computed(
  () => authStore.userData.telegram === "" || authStore.userData.telegram === null,
)

const isPhoneEditable = computed(
  () => authStore.userData.phone === "" || authStore.userData.phone === null,
)
                  ...
                  <VRow class="pt-1">
                    ...
                    >
                      <VBtn
                        color="primary"
                        type="submit"
                        :disabled="!isTelegramEditable && !isPhoneEditable"
